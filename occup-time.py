...
if t_tot<=0:
    t_tot= (len(occup_scat_files)-1)*timestep_for_selected_file*1000
...
fig.savefig('occup_time_Ttot%dfs_Step%dfs.png'%(t_tot,timestep_for_selected_file*1000), bbox_inches="tight")
